...
{
    public WindowsCaptureSession(IntPtr hwnd, WindowsCaptureSessionOptions options)
    {
    ...
    /// <summary>
    ///获取帧参数，第一个参数是获取到的帧，第二个参数是继续获取下一帧
    /// </summary>
    ...
    public async void StartCaptureMonitor(IntPtr hand,Action beforeFirstFrame = null)
    {
        try
        {
            _picker = new GraphicsCapturePicker();
            ...
            // _picker.
            // _picker
            var item = CaptureHelper.CreateItemForMonitor(hand);
                //await _picker.PickSingleItemAsync();
    ...
    public async void StartCaptureWindows(IntPtr hand, Action beforeFirstFrame = null)
    {
        try
        {
            _picker = new GraphicsCapturePicker();
            ...
            // _picker.
            // _picker
            var item = CaptureHelper.CreateForWindow(hand);
            //await _picker.PickSingleItemAsync();
